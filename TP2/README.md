...
- `RESUME_PATH` points to `data/resume.pdf`.
...
The index is created automatically if it does not exist, using a configuration compatible with the selected embedding model.[4][5][6]
