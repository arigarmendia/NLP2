...
```
    ...
    MPS available: True
    MPS built: True
    tensor([-1.1881, -0.0506,  0.6900,  0.2107,  1.5153, -1.0075,  0.2225, -1.3959,
             0.0349,  0.9673], device='mps:0')
...
```
    ...
    loss 2.10550: 100%|██████████| 11246/11246 [05:33<00:00, 33.70it/s]


    Epoch 1 training loss: 2.1013


    val_loss 2.01428: 100%|██████████| 1246/1246 [00:08<00:00, 139.89it/s]


    Epoch 1 validation loss: 2.0486


    loss 2.15602: 100%|██████████| 11246/11246 [05:24<00:00, 34.67it/s]


    Epoch 2 training loss: 2.0817


    val_loss 2.01428: 100%|██████████| 1246/1246 [00:08<00:00, 145.30it/s]

    Epoch 2 validation loss: 2.0486
    Training complete.
...
```
    ...
    'To be worg,\nWher alus thean youll! he tave thoy thit, pancounere thour futhentoowe you spand onk you.\n\nHo'
...
```
    ...
    'To beago nom.\n\nFhe Corthepot whis gith hery the suleee forr force\nthenoll? thent of fors!\n\n\nSet Cirst shu'
...
```
    ...
    'To bead with\nWhe asto hear four the beares.\n\nCOMINIANUS:\nThe blent mell bof and your\nFor in pear pill mon'
...
```
    ...
    'To be gomices:\nBus he thop popon of savourst svhiurs, noodiger deroy.\n\nCORIOLAUS:\nWhat you rlves; it, sho'
...
```
    ...
    'To bes.\n\nCOLANUS:\nCire thand ase dis dour.\n\nThishe he Core noow besenoce ant of to the trerims; paricut m'
...
```
    ...
    'To be in lech our the an de hom dairing dold, wipourt sealy the mare to noshe is st and,\nWe hit you sere '
...
* Con una temperatura más alta, se observa que la salida es más variada y creativa.
* La función combinada genera algo se ameja más a una oración, con aspectos de puntuación y estructura, pero sigue siendo incoherente en general.
...
```
    ...
    loss 1.58570: 100%|██████████| 11246/11246 [36:19<00:00,  5.16it/s] 
    ...
    ---> 16     avg_train_loss = trainer.train_model_v2(use_amp=True, dtype=torch.bfloat16)
         17     print(f"Epoch {epoch+1} training loss: {avg_train_loss:.4f}")
         19     val_loss = trainer.eval_model()


    File ~/Desktop/github_repos/NLP2/TP1/trainer.py:310, in Trainer.train_model_v2(self, use_amp, dtype)
        308 self.save_checkpoint(global_step, final=True)
        309 torch.mps.empty_cache() if self.device == 'mps' else torch.cuda.empty_cache()  # MPS-specific empty cache
    --> 310 return torch.mean(torch.stack(losses[-10:])).item()
...
![png](TinyGPT_files/TinyGPT_51_0.png)
    



    
![png](TinyGPT_files/TinyGPT_51_1.png)
